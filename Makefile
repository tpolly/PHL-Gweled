...
pkgdatadir = $(datadir)/gweled
pkgincludedir = $(includedir)/gweled
pkglibdir = $(libdir)/gweled
pkglibexecdir = $(libexecdir)/gweled
...
ACLOCAL = ${SHELL} /opt/BA/Distraction-Tasks/Gweled-src/missing --run aclocal-1.11
ALL_LINGUAS = 
AMTAR = ${SHELL} /opt/BA/Distraction-Tasks/Gweled-src/missing --run tar
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} /opt/BA/Distraction-Tasks/Gweled-src/missing --run autoconf
AUTOHEADER = ${SHELL} /opt/BA/Distraction-Tasks/Gweled-src/missing --run autoheader
AUTOMAKE = ${SHELL} /opt/BA/Distraction-Tasks/Gweled-src/missing --run automake-1.11
AWK = gawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /opt/BA/Distraction-Tasks/Gweled-src/missing --run makeinfo
MIKMOD_CFLAGS = 
MIKMOD_LIBS = -L/usr/lib -lmikmod
MKDIR_P = /bin/mkdir -p
...
PTHREAD_LIBS = 
RSVG_CFLAGS = -pthread -I/usr/include/librsvg-2.0 -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/libpng16 -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng16
...
abs_builddir = /opt/BA/Distraction-Tasks/Gweled-src
abs_srcdir = /opt/BA/Distraction-Tasks/Gweled-src
abs_top_builddir = /opt/BA/Distraction-Tasks/Gweled-src
abs_top_srcdir = /opt/BA/Distraction-Tasks/Gweled-src
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /opt/BA/Distraction-Tasks/Gweled-src/install-sh
...
pdfdir = ${docdir}
prefix = /opt/BA/Distraction-Tasks/Gweled-bin
...
installdirs-am:
	for dir in "$(DESTDIR)$(pixmapdir)" "$(DESTDIR)$(soundsdir)"; do \
...
uninstall-am: uninstall-pixmapDATA uninstall-soundsDATA
